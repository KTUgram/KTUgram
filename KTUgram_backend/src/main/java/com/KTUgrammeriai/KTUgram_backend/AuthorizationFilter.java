...
public class AuthorizationFilter extends BasicAuthenticationFilter {
    private static final List<String> LOCAL_APIS = Arrays.asList(
                    new String[] {"/user/re-login", "/user/login", "/user/logout", "/user/register", "/user/confirm", "/translations", "/user/get-access-token", "/v1", "/actuator/prometheus", "/user/check-username"});
